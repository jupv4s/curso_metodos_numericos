...
public:
    ...
    // --- NUEVOS OPERADORES DE ASIGNACIÓN COMPUESTA ---
    
    // Operador de suma y asignación (ej: c1 += c2)
    ...
    // Operador de multiplicación y asignación (ej: c1 *= c2)
    Complex<T>& operator*=(const Complex<T>& other) {
...
// Representación polar en string
template <class T>
